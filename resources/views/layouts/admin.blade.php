  ...
  <ul class="menu-inner py-1">
    ...
    <li class="menu-item ">
      <a href="javascript:void(0);" class="menu-link menu-toggle" >
        ...
        <div class="text-truncate">E-mail Templates</div>
      </a>

        <ul class="menu-sub">
          <li class="menu-item ">
            <a href="{{route('admin.email-templates.index')}}" class="menu-link" >
              <div>Manage Template</div>
            </a>
          </li>
          
          <li class="menu-item ">
            <a href="{{route('admin.email-templates.create')}}" class="menu-link" >
    ...
    <li class="menu-item ">
        ...
        <ul class="menu-sub">
          ...
          <li class="menu-item">
            <a href="{{ route('admin.payment-gateways.create') }}" class="menu-link">
                <div>Create Template</div>
            </a>
          </li>
        </ul>
    ...
    <li class="menu-item ">
      <a href="javascript:void(0);" class="menu-link menu-toggle" >
        <i class="menu-icon tf-icons bx bx-layout"></i>
        <div class="text-truncate">Manage Deposit</div>
      </a>
      ...
      <ul class="menu-sub">
        ...
        <li class="menu-item">
          <a href="{{ route('admin.deposits.approved') }}" class="menu-link">
              <div>Approved</div>
          </a>
        </li>
        <li class="menu-item">
          <a href="{{ route('admin.deposits.rejected') }}" class="menu-link">
              <div>Declined</div>
          </a>
        </li>
      </ul>
